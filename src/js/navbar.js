...
<div class="row divfoot">
  ...
  <div class="col-6 col-md-2 mb-3">
    <h5>Categorías</h5>
    <ul class="nav flex-column">
      <li class="nav-item mb-2"><a href="./productos.html#phish" class="nav-link p-0 text-body-secondary">Phishblock Kids</a></li>
      <li class="nav-item mb-2"><a href="./productos.html#mailSen" class="nav-link p-0 text-body-secondary">MailSentinel</a></li>
      <li class="nav-item mb-2"><a href="./productos.html#phemi" class="nav-link p-0 text-body-secondary">Phemi</a></li>
    </ul>
  </div>
